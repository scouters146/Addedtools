...
{
    PURE_AMETHYST("pure_amethyst",24,new int[]{3, 5, 7, 3},9,SoundEvents.ARMOR_EQUIP_GOLD,1.0f,0.0f,()->{
        return Ingredient.of(ItemInit.PURE_AMETHYST.get());
    });
    ...
    public String getName() {
        return Addedtoolsmod.MOD_ID + ":" + this.name;
    }
